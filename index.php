...
<body>
    ...
    <div class="row"> -->
        ...
        // foreach ($posts as $day => $datePosts) {
        //     var_dump($day);
        //     echo "<br>";
        //     echo "$day" . "<br>";
        //     foreach ($datePosts as $content) {
        //         var_dump($content);
        //         echo $content["title"];
        //     }
        // }
    ...
    //                 "paragraph" => "Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.<br>
    ...
    //                 "paragraph" => "Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:<br>
    ...
    //                 "paragraph" => "Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell'ultimo anno.<br>
